...
/**
 * Every villager suddenly thinks you're their best customer (master-spec Silver Tongue, sacrificial item
 * EMERALD BLOCK): villager trades are {@code silverTongueDiscount} (75%) cheaper. Implemented in
